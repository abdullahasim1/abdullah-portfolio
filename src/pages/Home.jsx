      ...
      <div className="w-full flex justify-center">
        <div className="max-w-3xl text-center space-y-6" ref={headingRef}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 text-xs place-items-center mx-auto max-w-2xl">
            <span className="inline-flex items-center justify-center rounded-full border border-gray-200/70 dark:border-gray-800/70 px-3 py-2 bg-white/50 dark:bg-black/30 backdrop-blur">Backend Development</span>
            <span className="inline-flex items-center justify-center rounded-full border border-gray-200/70 dark:border-gray-800/70 px-3 py-2 bg-white/50 dark:bg-black/30 backdrop-blur">Mobile Apps</span>
            <span className="inline-flex items-center justify-center rounded-full border border-gray-200/70 dark:border-gray-800/70 px-3 py-2 bg-white/50 dark:bg-black/30 backdrop-blur">Web Apps</span>
            <span className="inline-flex items-center justify-center rounded-full border border-gray-200/70 dark:border-gray-800/70 px-3 py-2 bg-white/50 dark:bg-black/30 backdrop-blur">UI/UX Design</span>
          </div>
          <div className="pt-2">
